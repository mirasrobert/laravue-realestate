<template>
    ...
    <div class="container mx-auto px-4">
        <h5 class="block font-semibold text-2xl mb-3">
            Classy Home in Calyton - $690.00
        </h5>
        <span class="text-sm bg-emerald-500 px-3 py-2 text-white rounded-full">
            For Sale
        </span>
        <span class="text-sm bg-red-500 px-3 py-2 text-white rounded-full ml-3">
            Discounted - 10%
        </span>

        <h4 class="font-medium font-semibold text-lg block mt-4 text-gray-800">
            9087 Gottlieb Row Apt. 389
        </h4>
        <div>
        ...
        <div class="mb-10">
            ...
            <p class="font-sm text-gray-800 mb-4">
                ...
                Blanditiis delectus deserunt est impedit nihil officia quisquam
                sed sequi sunt tempora! A architecto, dolore exercitationem
                facilis labore minima perferendis rem voluptas!
            </p>
            <p class="font-sm text-gray-800 mb-4">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                Blanditiis delectus deserunt est impedit nihil officia quisquam
