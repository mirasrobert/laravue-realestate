<template>
    <footer class="text-gray-600 body-font bg-indigo-700 mt-10">
        <div
        ...
        >
            ...
            >
                ...
                >
                    <svg
                        ...
                        class="w-10 h-10 text-white p-2 bg-pink-600 rounded-full"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                    >
                    ...
                    <span class="ml-3 text-xl text-white">HM</span>
                </a>
            ...
            >
                <div class="lg:w-1/4 md:w-1/2 w-full px-4">
                    <h2
                        class="title-font font-bold text-white tracking-widest text-md mb-3"
                    >
                        CATEGORIES
                    </h2>
