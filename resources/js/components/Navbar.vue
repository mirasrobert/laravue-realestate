            ...
            >
                ...
                >
                    <div class="flex flex-row items-center justify-between p-4">
                        <router-link
                            :to="{ name: 'Home' }"
                            class="logo-text text-lg font-semibold tracking-widest text-gray-900 uppercase rounded-lg dark-mode:text-white focus:outline-none focus:shadow-outline"
                            >House Marketplace</router-link
                        >
                        <button
                    ...
                    >
                        ...
                        <div
                            class="relative mt-3 md:mt-0 text-gray-600 block md:hidden lg:block"
                        >
                            <input
